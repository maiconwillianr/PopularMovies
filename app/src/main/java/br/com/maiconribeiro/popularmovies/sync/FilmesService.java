...
public class FilmesService {
    ...
    public void buscarFilmesPorGenero(String page, String genero, String dataInicio,
                                      String dataFim, String filtroPesquisa) {
        ...
        if (Util.checkConnection(context)) {
            ...
            final String GENRES_VALUE = genero;
            ...
            Uri builtUri = Uri.parse(URL_BASE).buildUpon()
                    ...
                    .appendQueryParameter(PAGE_PARAM, page)
                    .appendQueryParameter(SORT_BY_PARAM, SORT_BY_VALUE)
                    .appendQueryParameter(GENRES_PARAM, GENRES_VALUE)
                    .appendQueryParameter(API_KEY, BuildConfig.THE_MOVIE_DB_API_KEY)
                    .build();
